  ...
  return (
    <div className="bg-white w-full flex flex-1 flex-col min-h-full" style={{ fontFamily: 'Inter, sans-serif', fontSize: '10px', color: '#222' }}>
      ...
      <div className="resume-template-body flex flex-1 items-stretch relative">
        {/* LEFT COLUMN */}
        <div className="flex-shrink-0 p-4 self-stretch flex flex-col gap-4" style={{ width: 185, background: '#f9f9f9', borderRight: '1px solid #e5e7eb' }}>
        ...
        <div className="flex-1 p-4 flex flex-col gap-2">
          <div className="resume-break-unit">
            ...
            <p><strong>Образование:</strong> {educationSummary}</p>
              ...
              return (
                <div key={work.id} className="mb-3 last:mb-0">
                  <div className="resume-break-unit">
                    ...
                    {hasText(work.rank) && <p><strong>Звание:</strong> {work.rank}</p>}
                  </div>
        ...
        >
          ...
          {militarySummary && militarySummary !== 'Не служил' && (
            <p className="mb-1.5">
              <strong>Служба в армии:</strong> {militarySummary}.
            </p>
          )}
